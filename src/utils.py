...
def preprocess_data(file_name):
    ...
    print(new_df['MBTI'].value_counts())
    print(new_df['MBTI'].value_counts()/len(new_df))
...
def prepare_dataset(name, training_test_ratio: float = 0.4) -> None:
